...
export default function FreeBeats() {
  ...
  return (
    <>
      <Container className="mx-auto mb-8 bg-rokefelaBlack md:mb-16 xl:mb-24">
        ...
        <article>
          <div>
            ...
            <Formik
              ...
              <Form
                className={`${isOpen ? "visible opacity-100" : "invisible opacity-0"} mx-4 box-border flex w-[calc(100%-32px)] items-center justify-center bg-rokefelaBlack text-center opacity-0 drop-shadow-lg transition-all sm:mx-8 sm:w-[calc(100%-64px)] lg:mx-auto lg:max-w-xl lg:px-8`}>
