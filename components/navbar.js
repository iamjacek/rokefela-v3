...
function Header({ linksHidden }) {
  ...
  if (linksHidden) {
    return (
      <a
        href="/"
        className="absolute left-[50%] z-10 mt-4 max-h-[100px] max-w-[100px] translate-x-[-50%] lg:left-[0] lg:ml-8 lg:mt-4 lg:translate-x-[0] xl:ml-12 xl:mt-8">
        <Image
          src="/img/footer_image.png?v=08"
          alt="8 free for profits beats"
          width="500"
          height="500"
          className="h-full w-full object-cover object-right md:h-full"
        />
      </a>
    );
  } else {
